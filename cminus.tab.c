...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    CHAVESESQUERDA = 274,
    CHAVESDIREITA = 275,
    COLCHETESESQUERDA = 276,
    COLCHETESDIREITA = 277,
    ID = 278,
    NUM = 279,
    MAIS = 280,
    MENOS = 281,
    VEZES = 282,
    DIVIDIR = 283,
    PARENTESESESQUERDA = 284,
    PARENTESESDIREITA = 285,
    ERROR = 286
  };
#endif
...
{
       0,    34,    34,    38,    41,    51,    54,    58,    62,    69,
      74,    80,    92,    96,   100,   108,   112,   116,   122,   133,
     142,   145,   154,   157,   159,   161,   163,   165,   169,   171,
     175,   180,   187,   194,   196,   201,   206,   210,   213,   220,
     226,   230,   233,   236,   240,   243,   246,   251,   257,   263,
     267,   273,   279,   283,   285,   287,   289,   293,   299,   300,
     303,   311,   315,   319,   324
};
#endif
...
{
  "$end", "error", "$undefined", "ENDFILE", "PONTOEVIRGULA", "VIRGULA",
  "IF", "INT", "ELSE", "RETURN", "VOID", "WHILE", "RECEBE", "MENORQUE",
  "MAIORQUE", "IGUAL", "DIFERENTE", "MENORIGUAL", "MAIORIGUAL",
  "CHAVESESQUERDA", "CHAVESDIREITA", "COLCHETESESQUERDA",
  "COLCHETESDIREITA", "ID", "NUM", "MAIS", "MENOS", "VEZES", "DIVIDIR",
  "PARENTESESESQUERDA", "PARENTESESDIREITA", "ERROR", "$accept",
  ...
  "termo", "fator", "ativacao", "args", "arg_lista", "identificador",
  "num", "vazio", YY_NULLPTR
};
#endif
...
{
      44,   -53,   -53,     7,    44,   -53,   -53,    11,   -53,   -53,
     -53,   -53,     0,   -53,     6,    45,   -53,    34,    28,    11,
      30,    69,   -53,    78,    62,    65,    44,   -53,    63,   -53,
     -53,   -53,   -53,    44,   -53,   -53,    11,     4,   -53,     5,
     -53,    57,    12,    58,   -53,   -18,   -53,   -53,   -53,   -53,
     -53,   -53,    84,    77,   -53,    55,   -10,   -53,   -53,    -9,
     -53,   -18,   -53,    86,   -18,    61,   -53,   -18,   -53,   -53,
     -53,   -53,   -53,   -53,   -18,   -18,   -18,   -18,   -18,   -18,
     -18,    64,   -53,    66,   -53,   -53,   -53,   -10,   -10,    14,
     -53,   -53,    70,   -53,    67,    88,   -53,    38,    38,   -53,
     -53,   -18,    87,   -53,   -53,    38,   -53
};
...
static const yytype_int8 yydefact[] =
{
       ...
       4,    62,     0,     7,     0,     0,    63,     0,    10,     0,
       0,    12,    15,     0,    16,     0,     0,     8,     0,    64,
      11,    14,    17,    64,    20,    19,     0,     0,    22,     0,
      29,     0,     0,     0,    18,     0,    24,    21,    23,    25,
      26,    27,     0,    54,    36,    40,    49,    52,    55,    37,
      56,     0,    33,     0,     0,     0,    28,     0,    42,    43,
      45,    46,    41,    44,     0,     0,     0,     0,     0,     0,
      64,     0,    34,     0,    53,    35,    54,    47,    48,    39,
      50,    51,     0,    61,     0,    58,    59,     0,     0,    38,
      57,     0,    30,    32,    60,     0,    31
};
...
{
     -53,   -53,   -53,    94,    68,    17,   -53,   -53,   -53,    73,
      75,   -53,   -53,   -52,   -53,   -53,   -53,   -53,   -42,     1,
     -53,   -53,    26,   -11,   -12,   -53,   -53,   -53,    -5,    89,
     -32
};
...
{
      63,    38,    12,    65,    13,    11,    16,     9,    40,    13,
      41,    45,    79,    42,    24,    43,    62,    77,    78,    81,
      80,    14,    83,    29,    44,    85,    14,    11,    16,    15,
      16,    39,    19,    45,    11,    11,    16,    92,    93,    74,
      75,    45,    40,    19,    41,   102,   103,    42,    96,    43,
      36,     1,     1,   106,     2,    18,    23,    29,   -13,   104,
      25,    11,    16,    87,    88,    90,    91,    45,    68,    69,
      70,    71,    72,    73,    26,    86,    86,    86,    86,    86,
      74,    75,    27,    28,    29,    32,    61,    64,    66,    67,
      82,    84,    99,   101,    97,   105,    98,   100,    10,    31,
      30,    35,    89,    17
};

static const yytype_int8 yycheck[] =
{
      42,    33,     7,    45,     4,    23,    24,     0,     4,     4,
       6,    29,    21,     9,    19,    11,     4,    27,    28,    61,
      29,    21,    64,    19,    20,    67,    21,    23,    24,    29,
      24,    36,    15,    29,    23,    23,    24,    79,    80,    25,
      26,    29,     4,    26,     6,    97,    98,     9,    80,    11,
      33,     7,     7,   105,    10,    10,    22,    19,    30,   101,
      30,    23,    24,    74,    75,    77,    78,    29,    13,    14,
      15,    16,    17,    18,     5,    74,    75,    76,    77,    78,
      25,    26,     4,    21,    19,    22,    29,    29,     4,    12,
       4,    30,    22,     5,    30,     8,    30,    30,     4,    26,
      25,    33,    76,    14
};
...
{
       0,     7,    10,    33,    34,    35,    36,    37,    38,     0,
      35,    23,    60,     4,    21,    29,    24,    61,    10,    37,
      39,    40,    41,    22,    60,    30,     5,     4,    21,    19,
      42,    41,    22,    43,    62,    36,    37,    44,    62,    60,
       4,     6,     9,    11,    20,    29,    42,    45,    46,    47,
      48,    49,    50,    51,    52,    54,    55,    56,    57,    60,
      61,    29,     4,    50,    29,    50,     4,    12,    13,    14,
      15,    16,    17,    18,    25,    26,    53,    27,    28,    21,
      29,    50,     4,    50,    30,    50,    51,    55,    55,    54,
      56,    56,    50,    50,    58,    59,    62,    30,    30,    22,
      30,     5,    45,    45,    50,     8,    45
};
